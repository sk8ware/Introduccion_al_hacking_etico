...
```
Me podrías ayudar a crear un README estructurado con los temas y conceptos de mi repositorio de github, tengo como carpetas y temas principales: INTRODUCCIÓN A LINUX Introducción al Hacking MAQUINAS REALIZADAS Personalización del entorno en Linux Python ofensivo En introducción a Linux tengo estos temas: Actualización y Upgradeo del sistema (14).md Asignación de permisos (6).md Búsquedas a nivel de sistema (16).md Comandos básicos de Linux (1).md Control de atributos de ficheros en Linux – Chattr y Lsattr (9).md Control del flujo stderr-stdout, operadores y procesos en segundo plano (2).md Cuestionario (4).md Descriptores de archivo (3).md Estructura de directorios del sistema (12).md Lectura e interpretación de permisos (5).md Notación octal de permisos (7).md Permisos especiales – SUID y SGID (10).md Permisos especiales – Sticky Bit (8).md Privilegios especiales – Capacidades (11).md Prueba.md Sistemas operativos para pentesting 0.md Uso de bashrc y zshrc (13).md Uso y manejo con Tmux (15).md En introducción al hacking tengo estos temas: (carpeta)Subredes: Subredes – CIDRs y cálculo total de hosts.md Subnetting – Interpretación de los rangos de red que el cliente nos ofrece para auditar.md Subnetting – Máscaras de subred, tipos de clase e interpretación de prefijos de red.md Subnetting – Qué es y cómo se interpreta una máscara de red.md Subredes – Redes extrañas y casos particulares.md TIPS de subnetting y cálculo veloz de direccionamiento en redes.md Temas: Direcciones IP (IPV4 e IPV6).md Direcciones MAC (OUI y NIC).md El modelo OSI – En qué consiste y cómo se estructura la actividad de red en capas.md Protocolos comunes (UDP, TCP) y el famoso Three-Way Handshake.md Conceptos básicos de enumeración y explotación: (carpeta)Conceptos básicos de IP, MAC, UDP, TCP, OSI, ETC: Direcciones IP (IPV4 e IPV6).md Direcciones MAC (OUI y NIC).md El modelo OSI – En qué consiste y cómo se estructura la actividad de red en capas.md Protocolos comunes (UDP, TCP) y el famoso Three-Way Handshake.md (carpeta)Conceptos básicos de enumeración y explotación: Enumeración del sistema.md Introducción a BurpSuite.md Introducción a la explotación de vulnerabilidades.md Shells inversos, Shells vinculados y Shells delanteros.md Tipos de explotación (Manuales y Automatizadas).md Tipos de cargas útiles (Staging y Non-Staging).md (carpeta)Enumeración de servicios comunes y gestores de contenido: (carpeta)Enumeración de gestores de contenido CMS: Drupal.md Joomla.md Magento.md WordPress (1-2).md WordPress (2-2).md (dentro de la carpetaEnumeración de servicios comunes y gestores de contenido): Enumeración del servicio FTP.md Enumeración del servicio HTTP y HTTPS.md Enumeración del servicio SMB.md Enumeración del servicio SSH.md (carpeta)Introducción a Docker: Carga de instrucciones en Docker y desplegando nuestro primer contenedor.md Comandos comunes para la gestión de contenedores.md Creación y construcción de imágenes.md DOCKER.md Definiendo la estructura básica de Dockerfile.md Despliegue de máquinas vulnerables con Docker-Compose (1-2).md Instalación de Docker en Linux.md PRUEBA DOCKER.md Port Forwarding en Docker y uso de monturas.md (carpeta)OWASP TOP 10 y vulnerabilidades web: Falsificación de solicitudes entre sitios (CSRF).md Secuencias de comandos entre sitios (XSS) 1-2.md Inclusión de archivos locales (LFI).md Envenenamiento de registros (LFI - RCE).md Inclusión remota de archivos (RFI).md Inyección SQL (SQLI).md Falsificación de solicitudes del lado del servidor (SSRF).md Inyección de plantilla del lado del servidor (SSTI).md Inyección de entidad externa XML (XXE).md (carpeta)Reconocimiento con Nmap: Alternativas para la enumeración de puertos usando descriptores de archivo.md Creación de tus propios scripts en Lua para nmap.md Credenciales y brechas de seguridad.md Cuestionario de Nmap.md Descubrimiento de correos electrónicos.md Descubrimiento de equipos en la red local (ARP e ICMP) y Tips.md Enumeración de subdominios.md Fuzzing y enumeración de archivos en un servidor web (1-2).md Fuzzing y enumeración de archivos en un servidor web (2-2).md Google Dorks - Google Hacking (Los 18 Dorks más usados).md Identificación de las tecnologías en una página web.md Identificación y verificación externa de la versión del sistema operativo.md Reconocimiento de imágenes.md Scaneo con nmap y sus funciones.md Técnicas de evasión de Firewalls (MTU, Longitud de Datos, Puerto de Origen, Señuelo, etc.).md Uso de scripts y categorías en nmap para aplicar reconocimiento.md Validación del objetivo (Fijando un target en HackerOne).md
```
